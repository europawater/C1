...
public class ObjectManager
{
    ...
    public HashSet<Buddy> Buddys { get; private set; } = new HashSet<Buddy>();
    ...
    public Buddy SpawnBuddy(Transform parent, int templateID)
    {
        Buddy buddy = Managers.Resource.Instantiate(BUDDY_PREFAB_NAME, parent).GetComponent<Buddy>();
        if (buddy != null)
        {
