...
public class DungeonData
{
	...
	public EDungeonType DungeonType { get; private set; }
	...
	public DungeonData(JsonData json)
	{
		...
		DungeonType = (EDungeonType)Enum.Parse(typeof(EDungeonType), json["DungeonType"].ToString());
		DungeonLevel = int.Parse(json["DungeonLevel"].ToString());
		...
		RewardType = (ERewardType)Enum.Parse(typeof(ERewardType), json["RewardType"].ToString());
